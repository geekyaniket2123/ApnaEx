...
# ------------------------------------------------
API_ID = int(os.environ.get("API_ID", "20669593"))
# ------------------------------------------------
API_HASH = os.environ.get("API_HASH","4349e02d4c2cb480073b6d3d5495d75c")
# ------------------------------------------------
BOT_TOKEN = os.environ.get("BOT_TOKEN", "")
# ------------------------------------------------
BOT_USERNAME = os.environ.get("BOT_USERNAME", "@Meganz2123chatbot_bot")
BOT_TEXT = "GAJJU BHAI KA EXTRACTOR"
# ------------------------------------------------
OWNER_ID = int(os.environ.get("OWNER_ID", "784061923"))
# ------------------------------------------------
# //LOG CHANNEL ID 
